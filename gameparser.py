...
skip_words = ['a', 'about', 'all', 'an', 'and', 'another', 'any', 'around', 'at',
              ...
              'i', 'if', 'in', 'into', 'is', 'it', 'its', 'large', 'later', 'like',
              'little', 'main', 'me', 'mine', 'more', 'my', 'now', 'of', 'off',
              'oh', 'on', 'please', 'small', 'some', 'soon', 'that', 'the', 'then',
...
def normalise_input(user_input):
    ...
    normalised = filter_words(no_punct.split(), skip_words)
    return normalised
